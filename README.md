# Модуль AWZ: Решение конфликтов Яндекс карт [awz.ymapfix]

## Краткое описание

Модуль `awz.ymapfix` предназначен для решения конфликтов ключей и версий API Яндекс карт в проектах на Bitrix CMS. Он позволяет централизованно управлять подключением библиотеки `ymaps`, исключая дублирование и конфликты между различными модулями, использующими Яндекс Карты.
...
https://github.com/azahalski/awz.ymapfix/blob/master/CHANGELOG.md
